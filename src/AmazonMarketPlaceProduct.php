...
class AmazonMarketPlaceProduct
{
     ...
     * @return array
     */
    public function toArray($field_name = [],$toEncoding = true)
    {
        ...
        foreach ($field_name as $key){
            $arr[$key]= isset($list[$key])?$list[$key]:'';
        }
        return  $arr;
    }
     ...
     * @return AmazonMarketPlaceProduct
     */
    public function setUpdateDelete(string $update_delete)
    {
     ...
     * @return AmazonMarketPlaceProduct
     */
    public function setSizeMap(string $size_map)
    {
     ...
     * @return AmazonMarketPlaceProduct
     */
    public function setColorMap(string $color_map)
    {
